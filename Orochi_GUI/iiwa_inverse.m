...
for u=1:2
    ...
    T25 = double(R.A([3 4 5], [0 0 q3 q4(u) 0 0 0]).T);
    ...
    for v=1:2
        T15 = double(R.links(2).A(q2(v)).T*T25);     % T15 = T12*T25
        ...
        for w = 1:2
            T04_actual = double(R.A([1 2 3 4 5], [q1(w), q2(v), q3, q4(u), 0, 0, 0]).T);
